...
const listarProvincias = () => {
   let provincias = ['Seleccionar'];
    divisionPolitica.provincias.forEach(element => {
       provincias.push(element.title);
     });
     return provincias;
}


const listarCantones = (pProvincia) => {
   let cantones = ['Seleccionar'];
    divisionPolitica.provincias.forEach(provincia => {

        if(provincia.title == pProvincia){

            provincia.cantones.forEach(canton => {
               cantones.push(canton.title);
            });    
        }
...
const listarDistritos = (pProvincia, pCanton) => {
   let distritos = ['Seleccionar'];
    divisionPolitica.provincias.forEach(provincia => {
        if(provincia.title == pProvincia){
            provincia.cantones.forEach(canton => {
                if(canton.title == pCanton){
                    canton.distritos.forEach(distrito => {
                        distritos.push(distrito.title);
                    });                
                }
            });      
        }      
...
// listarProvincias();
// listarCantones('Alajuela');
// listarDistritos('Alajuela', 'Alajuela');
