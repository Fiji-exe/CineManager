...
const registrarTipoAsientoApi = async(pDatos, pEndPoint) => {
...
const obtenerTipoAsientoEditar = async(pEndPoint, query) => {
    let url = `http://localhost:3000/api${pEndPoint}`;
    let lista = [];
...
const actualizarTipoAsientoApi = async(pData, pEndPoint) => {
    let url = `http://localhost:3000/api${pEndPoint}`;
    let msj = '';
